  ...
  private void ExecLoad(Text sender, string targetFileName, bool forceLoad)
  {
    ...
    for (int ii = 0; ii < Fix.INFINITY; ii++)
    {
      ...
      for (int jj = 0; jj < tempCharacter.Length; jj++)
      {
        ...
        //  {
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.MainWeapon = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.MainWeapon = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.MainWeapon = new ItemBackPack(node.InnerText);
        //    }
        //  }
        //}
        //catch { }
        ...
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.SubWeapon = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.SubWeapon = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.SubWeapon = new ItemBackPack(node.InnerText);
        //    }
        //  }
        //}
        //catch { }
        ...
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.MainArmor = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.MainArmor = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.MainArmor = new ItemBackPack(node.InnerText);
        //    }
        //  }
        //}
        //catch { }
        ...
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.Accessory = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.Accessory = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.Accessory = new ItemBackPack(node.InnerText);
        //    }
        //  }
        //}
        //catch { }
        ...
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.Accessory2 = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.Accessory2 = new ItemBackPack(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.Accessory2 = new ItemBackPack(node.InnerText);
        //    }
        //  }
        //}
        //catch { }
        ...
        //      {
        //        One.MC.AddBackPack(new ItemBackPack(node.InnerText));
        //      }
        //      else
        //      {
        //        foreach (XmlNode node2 in temp2)
        //        {
        //          if (node2.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //          {
        ...
        //      if (temp2.Count <= 0) // 旧互換の場合、必ずスタック量は１つである。
        //      {
        //        One.SC.AddBackPack(new ItemBackPack(node.InnerText));
        //      }
        //      else
        //      {
        //        foreach (XmlNode node2 in temp2)
        //        {
        //          if (node2.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //          {
        //            for (int kk = 0; kk < Convert.ToInt32(node2.InnerText); kk++)
        //            {
        //              One.SC.AddBackPack(new ItemBackPack(node.InnerText));
        ...
        //      if (temp2.Count <= 0) // 旧互換の場合、必ずスタック量は１つである。
        //      {
        //        One.TC.AddBackPack(new ItemBackPack(node.InnerText));
        //      }
        //      else
        //      {
        //        foreach (XmlNode node2 in temp2)
        //        {
        //          if (node2.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //          {
        //            for (int kk = 0; kk < Convert.ToInt32(node2.InnerText); kk++)
        //            {
        //              One.TC.AddBackPack(new ItemBackPack(node.InnerText));
        ...
        //}
        //// e 後編編集
        //for (int ii = 0; ii < Fix.SOUL_ATTRIBUTE_NUM; ii++)
        //{
        ...
        //    if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //    {
        //      One.MC.CurrentSoulAttributes[ii] = Convert.ToInt32(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //    {
        //      One.SC.CurrentSoulAttributes[ii] = Convert.ToInt32(node.InnerText);
        //    }
        //    else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //    {
        //      One.TC.CurrentSoulAttributes[ii] = Convert.ToInt32(node.InnerText);
        //    }
        //  }
        //}
        ...
        //Type type = One.MC.GetType();
        //foreach (PropertyInfo pi in type.GetProperties())
        //{
        //  // [警告]：catch構文はSetプロパティがない場合だが、それ以外のケースも見えなくなってしまうので要分析方法検討。
        //  if (pi.PropertyType == typeof(System.Int32))
        //  {
        //    try { pi.SetValue(One.MC, Convert.ToInt32(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_MAINPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //    try { pi.SetValue(One.SC, Convert.ToInt32(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_SECONDPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //    try { pi.SetValue(One.TC, Convert.ToInt32(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_THIRDPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //  }
        //  else if (pi.PropertyType == typeof(System.String))
        //  {
        //    try { pi.SetValue(One.MC, xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_MAINPLAYERSTATUS + "/" + pi.Name).InnerText, null); }
        //    catch { }
        //    try { pi.SetValue(One.SC, xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_SECONDPLAYERSTATUS + "/" + pi.Name).InnerText, null); }
        //    catch { }
        //    try { pi.SetValue(One.TC, xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_THIRDPLAYERSTATUS + "/" + pi.Name).InnerText, null); }
        //    catch { }
        //  }
        //  else if (pi.PropertyType == typeof(System.Boolean))
        //  {
        //    try { pi.SetValue(One.MC, Convert.ToBoolean(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_MAINPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //    try { pi.SetValue(One.SC, Convert.ToBoolean(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_SECONDPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //    try { pi.SetValue(One.TC, Convert.ToBoolean(xml.DocumentElement.SelectSingleNode(@"/Body/" + Fix.NODE_THIRDPLAYERSTATUS + "/" + pi.Name).InnerText), null); }
        //    catch { }
        //  }
        //  // s 後編追加
        ...
        //        if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.MC, (MainCharacter.AdditionalSpellType)Enum.Parse(typeof(MainCharacter.AdditionalSpellType), node.InnerText), null);
        //        }
        //        else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.SC, (MainCharacter.AdditionalSpellType)Enum.Parse(typeof(MainCharacter.AdditionalSpellType), node.InnerText), null);
        //        }
        //        else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.TC, (MainCharacter.AdditionalSpellType)Enum.Parse(typeof(MainCharacter.AdditionalSpellType), node.InnerText), null);
        //        }
        //      }
        //    }
        //    catch { }
        ...
        //        if (node.ParentNode.Name == Fix.NODE_MAINPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.MC, (MainCharacter.AdditionalSkillType)Enum.Parse(typeof(MainCharacter.AdditionalSkillType), node.InnerText), null);
        //        }
        //        else if (node.ParentNode.Name == Fix.NODE_SECONDPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.SC, (MainCharacter.AdditionalSkillType)Enum.Parse(typeof(MainCharacter.AdditionalSkillType), node.InnerText), null);
        //        }
        //        else if (node.ParentNode.Name == Fix.NODE_THIRDPLAYERSTATUS)
        //        {
        //          pi.SetValue(One.TC, (MainCharacter.AdditionalSkillType)Enum.Parse(typeof(MainCharacter.AdditionalSkillType), node.InnerText), null);
        //        }
        //      }
        //    }
        //    catch { }
