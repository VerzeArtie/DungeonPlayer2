  ...
  public Item(string item_name)
  {
    ...
    switch (item_name)
    {
      ...
      case Fix.ELDERSTAFF_OF_LIFEBLOOM:
        ...
        this._gold = 510000;
        this._importantType = Important.None;
        this._description = "生命を司る大樹から選りすぐりの枝を切り取り、大杖の形状に仕立て上げた一品。際立った特徴はないが、手に持つだけで自然の生命力を感じる事が出来る。そこから放たれる魔力は計り知れない。魔法攻撃力１０８０～１３４０【特殊効果】戦闘開始時、味方フィールドに【エンジェリック・エコー】のBUFFが付与される。ライフを回復する場合、回復量が２０％上昇する。";
        this._strength = 0;
        this._agility = 0;
        this._intelligence = 0;
        this._stamina = 0;
      ...
      case Fix.LEGENDARY_FELTUS:
        ...
        this._gold = 0;
        this._importantType = Important.Precious;
        this._description = "剣の中枢部に微細な円環状の無空間を形成している剣。理そのものを示すその剣は時間律、因果律、そして生命の根源を断ち切る性質を有する。物理攻撃１～８９７４\r\n【特殊効果】任意の行動を行うたび、防御、待機以外であれば、【神の意志】カウンターがBUFFとして蓄積する。蓄積されたカウンターの分だけ、【心】パラメタが１００上昇する。最大99個まで蓄積が行える。対象に物理攻撃もしくは魔法攻撃がヒットした時、対象に【神の契約】カウンターが載せられた上で、【復活不可】および【ライフ回復不可】の効果を与える。本効果は対象が【復活不可】および【ライフ回復不可】に対する耐性を保持していたとしても適用される。【神の契約】カウンターがある限り、対象は【復活不可】【ライフ回復不可】を除去する事が出来ない。【神】の蓄積カウンターが１つ以上ある場合、自分自身の対象の物理攻撃／物理防御／魔法攻撃／魔法防御／戦闘速度／戦闘反応／潜在能力が減少するBUFFがかかっていたとしても減少効果は適用されなくなる。";
        break;
