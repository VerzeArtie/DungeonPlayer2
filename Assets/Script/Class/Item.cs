  ...
  public Item(string item_name)
  {
    ...
    switch (item_name)
    {
      ...
      case Fix.FULLMETAL_ASTRAL_BLADE:
        ...
        this._gold = 55000;
        this._importantType = Important.None;
        this._description = "完全な鋼鉄製のブレード。神々の姿をモチーフにした紋章が刻まれており、剣を振るった時に剣の重さを感じる事が無く、非常に強力な威力を発揮する。物理攻撃力１８０～２３０、力＋３２、心＋２０【特殊効果】物理攻撃が対象にヒットする度に、１０％の確率でインスタンスゲージが１０％進行する。";
        this._strength = 32;
        this._agility = 0;
        this._intelligence = 0;
        this._stamina = 0;
