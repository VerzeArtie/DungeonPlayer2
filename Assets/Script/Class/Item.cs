  ...
  public Item(string item_name)
  {
    ...
    switch (item_name)
    {
      ...
      case Fix.MYSTIC_BLUE_JAVELIN:
        ...
        this._gold = 270000;
        this._importantType = Important.None;
        this._description = "普通の槍とは異なり、柄の部分がかなり短めの設計で製作されている。柄の部分には蒼いドラゴンの装飾が施されており、また少しだけ婉曲している事から、対峙者に蒼き竜が食らいつく形で猛威を振るう。物理攻撃力７００～９００【特殊効果】戦闘開始時、スピード・ステップのBUFFが付与される。";
        this._strength = 0;
        this._agility = 0;
        this._intelligence = 0;
        this._stamina = 0;
      ...
      case Fix.STRONG_FIRE_HELL_BASTARDAXE:
        ...
        this._gold = 330000;
        this._importantType = Important.None;
        this._description = "熱く、強靭であり、豪快な紋様が描かれれている斧。その振る舞いは常に炎が周囲を纏うかの様に行われる。斧自体が圧力を放っており、その斧を持った物が戦闘モーションに入るだけで周囲敵を威圧する。物理攻撃力７６０～１０２０【特殊効果】戦闘開始時、味方フィールドにドミネーション・フィールドのBUFFが付与される。";
        this._strength = 0;
        this._agility = 0;
        this._intelligence = 0;
        this._stamina = 0;
      ...
      case Fix.AURA_BURN_CLAW:
        ...
        this._gold = 230000;
        this._importantType = Important.None;
        this._description = "先端部分に聖なるオーラを纏う魔力が施されている爪。そのため、装着した者が戦闘態勢に入ったとき、拳全体が光を纏っている様に見える。見た目の派手さだけではなく、実際に攻撃が繰り出される威力は想像を凌ぐ。物理攻撃力６２０～７２０【特殊効果】戦闘開始時、味方フィールドにレイライン・スキーマのBUFFが付与される。";
        this._strength = 0;
        this._agility = 0;
        this._intelligence = 0;
        this._stamina = 0;
