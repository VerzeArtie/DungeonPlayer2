...
public class PartyMenu : MotherBase
{
  ...
  public Text lblDetailBattlePercentPA;
  public Text lblDetailBattlePercentPD;
  public Text lblDetailBattlePercentMA;
  public Text lblDetailBattlePercentMD;
  public Text lblDetailBattlePercentBS;
  public Text lblDetailBattlePercentBR;
  public Text lblDetailBattlePercentPO;
  public Text lblDetailFireAmplify;
  public Text lblDetailFireResist;
  public Text lblDetailIceAmplify;
  public Text lblDetailIceResist;
  public Text lblDetailLightAmplify;
  public Text lblDetailLightResist;
  public Text lblDetailShadowAmplify;
  public Text lblDetailShadowResist;
  public Text lblResistPoison;
  public Text lblResistSilence;
  public Text lblResistBind;
  public Text lblResistSleep;
  public Text lblResistStun;
  public Text lblResistParalyze;
  public Text lblResistFrozen;
  public Text lblResistFear;
  public Text lblResistSlow;
  public Text lblResistDizzy;
  public Text lblResistSlip;
  ...
  public void TapSelectEssence(Text txt_title)
  {
    ...
    txtEssenceCurrentDescription.text = "～効果～　" + ActionCommand.GetDescription(txt_title.text);
  ...
  public override void RefreshAllView()
  {
    ...
    lblDetailBattlePercentPA.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_PA);
    lblDetailBattlePercentPD.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_PD);
    lblDetailBattlePercentMA.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_MA);
    lblDetailBattlePercentMD.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_MD);
    lblDetailBattlePercentBS.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_BS);
    lblDetailBattlePercentBR.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_BR);
    lblDetailBattlePercentPO.text = L10n.Get(Fix.L10N_DETAIL_BATTLE_PERCENT_PO);
    lblDetailFireAmplify.text = L10n.Get(Fix.L10N_DETAIL_FIRE_AMPLIFY);
    lblDetailFireResist.text = L10n.Get(Fix.L10N_DETAIL_FIRE_RESIST);
    lblDetailIceAmplify.text = L10n.Get(Fix.L10N_DETAIL_ICE_AMPLIFY);
    lblDetailIceResist.text = L10n.Get(Fix.L10N_DETAIL_ICE_RESIST);
    lblDetailLightAmplify.text = L10n.Get(Fix.L10N_DETAIL_LIGHT_AMPLIFY);
    lblDetailLightResist.text = L10n.Get(Fix.L10N_DETAIL_LIGHT_RESIST);
    lblDetailShadowAmplify.text = L10n.Get(Fix.L10N_DETAIL_SHADOW_AMPLIFY);
    lblDetailShadowResist.text = L10n.Get(Fix.L10N_DETAIL_SHADOW_RESIST);
    lblResistPoison.text = L10n.Get(Fix.L10N_DETAIL_RESIST_POISON);
    lblResistSilence.text = L10n.Get(Fix.L10N_DETAIL_RESIST_SILENCE);
    lblResistBind.text = L10n.Get(Fix.L10N_DETAIL_RESIST_BIND);
    lblResistSleep.text = L10n.Get(Fix.L10N_DETAIL_RESIST_SLEEP);
    lblResistStun.text = L10n.Get(Fix.L10N_DETAIL_RESIST_STUN);
    lblResistParalyze.text = L10n.Get(Fix.L10N_DETAIL_RESIST_PARALYZE);
    lblResistFrozen.text = L10n.Get(Fix.L10N_DETAIL_RESIST_FROZEN);
    lblResistFear.text = L10n.Get(Fix.L10N_DETAIL_RESIST_FEAR);
    lblResistSlow.text = L10n.Get(Fix.L10N_DETAIL_RESIST_SLOW);
    lblResistDizzy.text = L10n.Get(Fix.L10N_DETAIL_RESIST_DIZZY);
    lblResistSlip.text = L10n.Get(Fix.L10N_DETAIL_RESIST_SLIP);
